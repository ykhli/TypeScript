...
module ts {
    export var Diagnostics = {
        ...
        Export_assignment_is_not_supported_with_module_flag_is_system: { code: 1210, category: DiagnosticCategory.Error, key: "Export assignment is not supported with '--module' flag is 'system'." },
