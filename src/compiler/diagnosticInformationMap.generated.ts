...
namespace ts {
    export var Diagnostics = {
        ...
        Proper_external_modules_cannot_use_tripleslash_references: { code: 7027, category: DiagnosticCategory.Error, key: "Proper external modules cannot use tripleslash references." },
